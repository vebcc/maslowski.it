$(function() {
    var check_1 = (Math.floor(Math.random() * 9) + 1).toString(),
        ...
        //check = parseInt(check_1) + parseInt(check_2);
    ...
    $('#contactform').on('submit', function(e) {
        ...
        $.post($form.attr('action'), $form.serialize(), function(data) {
            ...
            $form.prepend('<div class="form-error">Wystąpił błąd podczas wysyłania formularza. Upewnij się, że wypełniłeś wszystkie pola i poprawnie rozwiązałeś działanie.'+data+'</div>');
